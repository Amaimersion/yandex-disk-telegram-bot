...
Revision ID: 358b1cefda13
Revises: e132de254282
Create Date: 2020-03-31 21:27:51.591688
...
def upgrade():
    ...
    sa.Column('access_token_expires_in', sa.BigInteger(), nullable=True, comment='Access token lifetime in seconds'),
    ...
    sa.Column('insert_token_expires_in', sa.BigInteger(), nullable=True, comment='Insert token lifetime in seconds'),
